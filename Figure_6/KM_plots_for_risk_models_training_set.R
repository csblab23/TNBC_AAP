...
# Here, keep only the samples that are present in training dataset
training_dataset_sub <- read_csv("training_dataset_sub.csv")
met_sub <- met_sub[training_dataset_sub$Run,] 

## Find maxstat cutoff for the clinical features
# For tumor size
...
## Figure 5a ------- Plot for clinical features only ------------------------------------------------------->>
...
test <- ggsurvplot(
  ...
  title = "Clinical Features Only (Training)",
  xlab = "Time (Months)",
  ylab = "Relapse Free Survival",
  legend.labs = c("0ev. (n = 27)", "1ev. (n = 175)", "2ev. (n = 45)"),
...
test
ggsave("24_12_KM_for_clin_features_train.png", test$plot, width = 7, height = 6, dpi = 1200,bg="white")


## Figure 5b ------- Plot for prognostic features (promoters) only ------------------------------------------------------->>
...
test <- ggsurvplot(
  ...
  size = 1.5,
  palette = c("purple", "magenta", "forestgreen"),
  title = "Promoter Features Only (Training)",
  xlab = "Time (Months)",
  ylab = "Relapse Free Survival",
  legend.labs = c("0ev. (n = 92)", "1ev. (n = 106)", "2ev. (n = 49)"),
  legend.title = "Risk Events",
...
test
ggsave("24_12_KM_for_prom_features_train.png", test$plot, width = 7, height = 6, dpi = 1200,bg="white")


## Figure 5c ------- Plot for all features (clinical + promoters) ------------------------------------------------------->>
# Find number of patients in each risk group
...
test <- ggsurvplot(
  ...
  size = 1.5,
  palette = c("purple", "magenta", "forestgreen"),
  title = "All Features (Training)",
  xlab = "Time (Months)",
  ylab = "Relapse Free Survival",
  legend.labs = c("0-1ev. (n = 87)", "2ev. (n = 100)", "3+ev. (n = 60)"),
  legend.title = "Risk Events",
  legend = c(0.75, 0.25),  # Adjust legend position inside the plot area
  risk.table = TRUE,
  risk.table.height = 0.2,
...
ggsave("24_12_KM_for_all_features_train.png", test$plot, width = 7, height = 6, dpi = 1200,bg="white")
