...
colnames(mm_finaldf)[122]

sfit <- survfit(Surv(mm_finaldf$RFS_time_Days, mm_finaldf$RFS_Status)~ mm_finaldf[,122], data=mm_finaldf)
test <- ggsurvplot(
  sfit,
  pval = TRUE,
  pval.method = TRUE,
  ...
  legend.labs = c("High (n = 144)", "Low (n = 214)"),
...
# For pr41492_FTX
grep('ENSG00000230590.13', colnames(mm_finaldf))
colnames(mm_finaldf)[124]
sfit <- survfit(Surv(mm_finaldf$RFS_time_Days, mm_finaldf$RFS_Status)~ mm_finaldf[,124], data=mm_finaldf)
test <- ggsurvplot(
  sfit,
  pval = TRUE,
  pval.method = TRUE,
  ...
  xlab = "Time (Days)",
  ylab = "Relapse Free Survival",
  legend.labs = c("High (n = 187)", "Low (n = 171)"),
  legend.title = "Risk Groups",
  legend = c(0.75, 0.25),  # Adjust legend position inside the plot area
  risk.table = TRUE,
  risk.table.height = 0.2,
...
test
ggsave("20_12_pr_41492_FTX.png", test$plot, width = 7, height = 6, dpi = 1200,bg = "white")

######################################################################################################

## Selecting the gene of interest -- 'HUWE1' -> it has 2 promoters out of which one is non-significant and other is significant:

# For pr3003_HUWE1
grep('ENSG00000086758.17', colnames(mm_finaldf))
colnames(mm_finaldf)[19]
sfit <- survfit(Surv(mm_finaldf$RFS_time_Days, mm_finaldf$RFS_Status)~ mm_finaldf[,19], data=mm_finaldf)
test <- ggsurvplot(
  sfit,
  pval = TRUE,
  pval.method = TRUE,
  ...
  xlab = "Time (Days)",
  ylab = "Relapse Free Survival",
  legend.labs = c("High (n = 176)", "Low (n = 182)"),
  legend.title = "Risk Groups",
  legend = c(0.75, 0.25),  # Adjust legend position inside the plot area
  risk.table = TRUE,
  risk.table.height = 0.2,
...
test
ggsave("KM_for_pr_3003_HUWE1.png", test$plot, width = 7, height = 6, dpi = 1200,bg = "white")

###########################################################################################################

# For pr3004_HUWE1
grep('ENSG00000086758.17', colnames(mm_finaldf))
colnames(mm_finaldf)[20]
sfit <- survfit(Surv(mm_finaldf$RFS_time_Days, mm_finaldf$RFS_Status)~ mm_finaldf[,20], data=mm_finaldf)
test <- ggsurvplot(
  sfit,
  pval = TRUE,
  pval.method = TRUE,
  ...
  xlab = "Time (Days)",
  ylab = "Relapse Free Survival",
  legend.labs = c("High (n = 246)", "Low (n = 112)"),
  legend.title = "Risk Groups",
  legend = c(0.75, 0.25),  # Adjust legend position inside the plot area
  risk.table = TRUE,
  risk.table.height = 0.2,
...
test
ggsave("KM_for_pr_3004_HUWE1.png", test$plot, width = 7, height = 6, dpi = 1200,bg = "white")

##########################################################################################

## SIMILARLY, MAKE KM PLOTS FOR THE GENES ----->>> 
...
# Load the cut off values file
final_cutoff_values <- readRDS('gene_cut_off_sub_int_false.rds')
...
# Plotting KM for FTX gene
grep('ENSG00000230590.13', colnames(mm_finaldf))
colnames(mm_finaldf)[62]
sfit <- survfit(Surv(mm_finaldf$RFS_time_Days, mm_finaldf$RFS_Status)~ mm_finaldf[,62], data=mm_finaldf)
test <- ggsurvplot(
  sfit,
  pval = TRUE,
  pval.method = TRUE,
  size = 1.5,
  palette = c( "lightslateblue", "aquamarine3"),
  title = "FTX",
  xlab = "Time (Days)",
  ylab = "Relapse Free Survival",
  legend.labs = c("High (n = 173)", "Low (n = 185)"),
  legend.title = "Risk Groups",
  legend = c(0.75, 0.25),  # Adjust legend position inside the plot area
  risk.table = TRUE,
  risk.table.height = 0.2,
...
test
ggsave("KM_for_FTX.png", test$plot, width = 7, height = 6, dpi = 1200,bg = "white")

#################################################################################################################

# KM plot for HUWE1 gene
grep('ENSG00000086758.17', colnames(mm_finaldf))
colnames(mm_finaldf)[14]
sfit <- survfit(Surv(mm_finaldf$RFS_time_Days, mm_finaldf$RFS_Status)~ mm_finaldf[,14], data=mm_finaldf)
test <- ggsurvplot(
  sfit,
  pval = TRUE,
  pval.method = TRUE,
  ...
  xlab = "Time (Days)",
  ylab = "Relapse Free Survival",
  legend.labs = c("High (n = 208)", "Low (n = 150)"),
  legend.title = "Risk Groups",
  legend = c(0.75, 0.25),  # Adjust legend position inside the plot area
  risk.table = TRUE,
  risk.table.height = 0.2,
...
test
ggsave("KM_for_HUWE1.png", test$plot, width = 7, height = 6, dpi = 1200,bg = "white")
